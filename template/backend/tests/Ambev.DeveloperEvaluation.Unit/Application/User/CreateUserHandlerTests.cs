...
using Ambev.DeveloperEvaluation.Unit.Application.User.TestData;
using AutoMapper;
using FluentAssertions;
using NSubstitute;
using Xunit;

namespace Ambev.DeveloperEvaluation.Unit.Application.TestsUser;
...
public class CreateUserHandlerTests
{
    ...
    public async Task Handle_ValidRequest_ReturnsSuccessResponse()
    {
        ...
        _userRepository.CreateAsync(Arg.Any<Ambev.DeveloperEvaluation.Domain.Entities.User>(), Arg.Any<CancellationToken>())
            .Returns(user);
        ...
        await _userRepository.Received(1).CreateAsync(Arg.Any<Ambev.DeveloperEvaluation.Domain.Entities.User>(), Arg.Any<CancellationToken>());
    }
    ...
    public async Task Handle_ValidRequest_HashesPassword()
    {
        ...
        await _userRepository.Received(1).CreateAsync(
            Arg.Is<Ambev.DeveloperEvaluation.Domain.Entities.User>(u => u.Password == hashedPassword),
    ...
    public async Task Handle_ValidRequest_MapsCommandToUser()
    {
        ...
        // Assert
        _mapper.Received(1).Map<Ambev.DeveloperEvaluation.Domain.Entities.User>(
